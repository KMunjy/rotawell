...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      // 'unsafe-inline' required by Next.js inline scripts; 'unsafe-eval' only in development
      ...
      "font-src 'self'",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.heygen.com https://*.heygen.com",
